...
function App() {
  ...
  return (
    <div style={styles.container}>
      ...
      <p>
        Scan your codebase, identify key files and generate a TXT file, ready to share with an external LLM”
      </p>
      ...
      {files.length > 0 ? (
        <>
          <p style={styles.note}>
            Recommended files pre-selected. Uncheck anything you don’t want included.
          </p>
